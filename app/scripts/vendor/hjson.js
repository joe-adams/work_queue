...
var Hjson = (function() {
    ...
    var hjson_parse = (function() {
        ...
        var array = function() {
            ...
            var kw, wat;
            if (keepWsc) {
                if (Object.defineProperty) Object.defineProperty(array, "__WSC__", {
                    enumerable: false,
                    writable: true
                });
                array.__WSC__ = kw = [];
        ...
        var object = function() {
            ...
            var kw, wat;
            if (keepWsc) {
                if (Object.defineProperty) Object.defineProperty(object, "__WSC__", {
                    enumerable: false,
                    writable: true
                });
                object.__WSC__ = kw = {
            ...
            function pushWhite(key) {
                kw.c[key] = getComment(wat);
                if (key) kw.o.push(key);
            }
    ...
    return {
        ...
        bracesSameLine: function() {
            return bracesSameLine;
        },
        setBracesSameLine: function(v) {
            bracesSameLine = v;
        },
